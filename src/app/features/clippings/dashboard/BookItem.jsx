...
import { Author, BookInfo, LastHighlight, NumHighlights, Row, RowGroup, StatisticLabel, StyledIcon, Title } from './BookItem.style'
...
const BookItem = ({ book }) => {
  ...
  return (
    <Row>
      ...
      <RowGroup>
        <Button style={{ marginRight: '32px' }} onClick={handleExportClick}>Export</Button>
        <Link to={`/highlights/${book.id}/${book.title}`}>
