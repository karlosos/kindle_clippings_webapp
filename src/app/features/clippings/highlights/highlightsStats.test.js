...
test('highlightStats should return correct statistics', () => {
    // WHEN
    const stats = highlightsStats(Object.values(quotes));

    // WHEN
    expect(stats).toEqual({
        firstDate: 'Wednesday 2021-05-19 17:07',
        highlightsCount: 3,
        lastDate: 'Wednesday 2021-05-19 22:24',
