...
const ImportPage = () => {
  ...
  return (
    <>
      ...
      <p>
        If you want to load demo data and you only want to check how this app
        works, then use the button below.
      </p>
      ...
      <p>
        If you want to delete all local data. This will remove all highlights,
        favourites, etc. There is no going back if you do not have a backup.
      </p>
