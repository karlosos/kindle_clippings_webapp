const clippings = {
  ...
  "302d6b99-c6b2-5113-9655-0c59f6af5372": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "history both to make their bets and to measure their risk). They would then terminate their trade. This is called a stop loss, a predetermined exit point, a protection from the black swan. I find it rarely practiced.",
    location: "2626-27",
  ...
  "8c64f3e4-327a-54f2-8edb-0a89739c2ccd": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "a budding knowledge of probability laws is to base their decision making on the following principle: It is very unlikely for someone to perform considerably well in a consistent fashion without his doing something right.",
    location: "2649-50",
  ...
  "31cf45be-b26d-5623-ad7d-6815d48e571a": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "Becoming rich is not directly a moral achievement, but that is not where the severe flaw in the book lies.",
    location: "2764-65",
  ...
  "90a4711e-89c9-5ac6-83ce-9270c36f207e": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "The story focuses on an unusual episode in history; buying its thesis implies accepting that the current returns in asset values are permanent (the sort of belief that prevailed before the great crash that started in 1929).",
    location: "2778-79",
  ...
  "7d25bd4a-3124-5390-a578-493a636ad11d": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "A result is that in real life, the larger the deviation from the norm, the larger the probability of it coming from luck rather than skills: Consider that even if one has 55% probability of heads, the odds of ten wins is still very small.",
    location: "2914-15",
  ...
  "0f3730e4-3320-5ac2-a826-07f391c3716c": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "A programmer helped me build a backtester. It is a software program connected to a database of historical prices, which allows me to check the hypothetical past performance of any trading rule of average complexity.",
    location: "3017-18",
  ...
  "6e569632-8e82-5f82-9246-6f6ef4cdc298": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "To get technical, there are even worse extensions. An outstanding recent paper by Sullivan, Timmerman, and White goes further and considers that the rules that may be in use successfully today may be the result of a survivorship ",
    location: "3026-27",
    time: "Thursday, May 06, 2021, 11:04 PM",
    favourite: false,
    deleted: false,
  ...
  "f2c1f0fc-5efa-5bd2-8e82-a24810e604a7": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "I wonder if those “experts” who make foolish (and self-serving) statements like “markets will always go up in any twenty-year period” are aware of this problem.",
    location: "3067-69",
  ...
  "34ba3beb-b213-579d-b47c-6c34bfce55f6": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "marred by a pernicious survivorship bias, affecting the way research gets published. In a way that is similar to journalism, research that yields no result does not make it to print. That",
    location: "3136-37",
  ...
  "fb4cfc86-5d83-52b9-a3d0-31628f511bfd": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "As I am writing these lines, I am suddenly realizing that the world’s bipolarity is hitting me very hard. Either one succeeds wildly, by attracting all the cash, or fails to draw a single penny. Likewise with books. Either everyone wants to publish it, or nobody is interested in returning telephone calls",
    location: "3286-88",
  ...
  "ea310397-61a2-572e-a7c4-0d332f522674": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "I am incapable of taming my emotions when reading their comments. The best I can do is just not read them. Likewise with journalists. Not reading their discussions of markets spares me plenty of emotional expenditure. I will do the same with unsolicited comments on this book. Wax in my ears.",
    location: "3865-67",
  ...
  "89a79d4e-927e-523e-910d-83da8fb02b16": {
    ...
    author: "Nassim Nicholas Taleb",
    quote:
      "Seneca’s Letters from a Stoic, a soothing and surprisingly readable book that I distribute to my trader friends (Seneca also took his own life when cornered by destiny).",
    location: "4225-26",
    time: "Sunday, May 09, 2021, 06:10 PM",
    favourite: false,
    deleted: false,
  ...
  "973cbc97-c878-58be-96b5-c6ce142fe491": {
    ...
    quote:
      "Everything external to us—good or bad, desirable or undesirable—can be used for our education and benefit. We can learn from both pleasure and pain, happiness and misery, success and failure.",
    location: "102-4",
  ...
  "a09fa781-b96a-58c2-a9c3-0d60e5b5d820": {
    ...
    author: "Charles Conrad",
    quote:
      "Those who remain pure in their thoughts grow old gracefully and serenely. Their waning years are bathed in beautiful, mellow hues, like a sunset over the ocean. ",
    location: "180-81",
  ...
  "1133b63a-8eb4-5b56-a074-b00267160f1c": {
    ...
    author: "Charles Conrad",
    quote:
      "There is no better medicine than cheerful thought for curing and preventing bodily ills. To wish the best for all people; to find the good in everything; to be content in all circumstances—such thoughts are the portal to heaven.",
    location: "183-84",
  ...
  "a0477802-3efe-5f42-a885-cab010897c99": {
    ...
    author: "Charles Conrad",
    quote:
      "Concentrate on doing your job as well as you can, however insignificant it may seem. This will develop and expand your ability to take on greater goals in the future.",
    location: "197-98",
  ...
  "e8d1b4f3-a154-5aeb-bd3e-d3e8057b17cc": {
    ...
    author: "Charles Conrad",
    quote:
      "Successful people put off gratification. They conceive goals, create plans, and execute those plans. They act independently, on their own initiative. They master their minds, and so master their circumstances.",
    location: "222-24",
  ...
  "0605e30b-66ee-5f32-86ac-8ba7bf57df4f": {
    ...
    author: "Charles Conrad",
    quote:
      "The higher you elevate your thoughts—expanding from desiring your own good, to the good of your family and friends, to the good of all people, to the good of the whole earth and all creatures—the greater will be your success, and the more enduring your achievements.",
    location: "224-26",
  ...
  "2e1a2790-59f2-5667-8c59-625b14198f2a": {
    ...
    author: "Greg Mckeown",
    quote:
      "A popular idea in Silicon Valley is “Done is better than perfect.”10 The sentiment is not that we should produce rubbish. The idea, as I read it, is not to waste time on nonessentials and just to get the thing done. In entrepreneurial circles the idea is expressed as creating a “minimal viable product.”",
    location: "2249-51",
  ...
  "3870a5b3-adef-5883-b585-3970644a75f2": {
    ...
    author: "Greg Mckeown",
    quote:
      "You will feel less and less a function of other people’s to-do lists and agendas. Remember that if you don’t prioritize your life someone else will. But if you are determined to prioritize your own life you can. The power is yours.",
    location: "2671-73",
  ...
  "39874519-ed31-5ffe-b8ac-ce12a3934c55": {
    ...
    quote:
      "Humans act according to their desires. If by ‘free will’ you mean the ability to act according to your desires – then yes, humans have free will, and so do chimpanzees, dogs and parrots.",
    location: "4207-8",
  ...
  "82d77371-65eb-5504-a69d-cea9c8c75422": {
    ...
    author: "Dan Luca",
    quote:
      "I discovered the fact that almost all great leaders in a wide range of fields wake up early in the morning. From Richard Branson to Tim Cook to Howard Schultz to Oprah Winfrey to Michael Phelps and Serena Williams, they all are early risers, mostly waking up before 6 a.m.",
    location: "115-17",
  ...
  "0b74436b-b84c-50fb-81c9-cfcbe6a47b0c": {
    ...
    author: "Dan Luca",
    quote:
      "As a general idea, the American Academy of Sleep Medicine suggests: think of the bedroom as a cave; it should be cool, quiet and dark.",
    location: "194",
  ...
  "72e4cc44-4665-508a-ba4a-599f108e1b40": {
    ...
    author: "Dan Luca",
    quote:
      "Most people who have trouble sleeping or experience restless sleep have completely counterproductive bedtime habits like watching news or highly stimulating shows on TV just before bed, trying to solve the unfinished businesses from that day or going to bed feeling upset about a conversation with their spouse or their child.",
    location: "452-54",
  ...
  "1023ce5b-965a-5c82-8b36-b5a391c95af3": {
    ...
    author: "Dan Luca",
    quote:
      "It’s very important that you avoid looking at the watch during all this time because doing so will stress you out even more.",
    location: "515-16",
  ...
  "a77d3c03-bd96-53a5-b14a-fc130c81dc04": {
    ...
    author: "Dan Luca",
    quote:
      "They HAD TO wake up…but I WANTED TO wake up. It’s a big difference in the sense that ‘when you don’t have a choice…it’s easy’.",
    location: "859-60",
  ...
  "98a012f0-0b95-5958-a466-85f383e6fac4": {
    ...
    author: "Dan Luca",
    quote:
      "3.    Your main focus is to finish the uncompleted tasks or projects and go to bed. This is essentially a reactive energy that is looking to mainly ‘land the plane’. But making personal changes require a different type of energy—a proactive one that is about ‘taking off’ and initiating new behaviour.",
    location: "885-87",
  ...
  "a3c09406-7fcd-5c63-842c-934b4231a870": {
    ...
    author: "Yuval Noah Harari",
    quote:
      "Bank clerks and travel agents, who a short time ago were completely secure from automation, have become endangered species. How many travel agents do we need when we can use our smartphones to buy plane tickets from an algorithm?",
    location: "4638-40",
  ...
  "f4e3b387-bcdb-5d9a-830e-a8e61f14729e": {
    ...
    author: "Yuval Noah Harari",
    quote:
      "Until a short time ago, facial recognition was a favourite example of something which even babies accomplish easily but which escaped even the most powerful computers on earth. Today facial-recognition programs are able to recognise people far more efficiently and quickly than humans can.",
    location: "4745-47",
  ...
  "93680745-0dc4-57ec-9229-19bda3fb506f": {
    ...
    author: "Yuval Noah Harari",
    quote:
      "If such algorithms consistently outperform human fund managers, we might end up with an algorithmic upper class owning most of our planet. This may sound impossible, but before dismissing the idea, remember that most of our planet is already legally owned by non-human inter-subjective entities, namely nations and corporations. Indeed, 5,000 years ago much of Sumer was owned by imaginary gods such as Enki and Inanna. If gods can possess land and employ people, why not algorithms?",
    location: "4799-4803",
  ...
  "b9c40441-0244-5e5c-8808-c30b9d19852d": {
    ...
    author: "Yuval Noah Harari",
    quote:
      "Google will also know that illness makes voters lean a bit more to the right than usual, and will compensate for this. Google will therefore be able to vote not according to my momentary state of mind, and not according to the fantasies of the narrating self, but rather according to the real feelings and interests of the collection of biochemical algorithms known as ‘I’.",
    location: "5054-56",
  ...
  "73c2b867-e077-59a5-b49c-1923bf0b9c24": {
    ...
    author: "Yuval Noah Harari",
    quote:
      "‘People might abandon their own psychological judgements and rely on computers when making important life decisions, such as choosing activities, career paths, or even romantic partners. It is possible that such data-driven decisions will improve people’s lives.’32",
    location: "5071-74",
  ...
  "c0a7e675-90e5-5c0d-8417-d6e5f79ade90": {
    ...
    author: "Yuval Noah Harari",
    quote:
      "The liberal solution for social inequality is to give equal value to different human experiences, instead of trying to create the same experiences for everyone. However, what will be the fate of this solution once rich and poor are separated not merely by wealth, but also by real biological gaps?",
    location: "5173-75",
    time: "Tuesday, May 18, 2021, 06:13 PM",
    favourite: false,
    deleted: false,
  ...
  "57f51b45-e740-54ab-893b-cc2acc55ac5a": {
    ...
    quote:
      "You can take these sentences, turn them into fill-in-the-blank exercises, add a few pictures, and learn a bunch of new words and word forms. The word Where, for instance, might go with _____ are you going? I’m going to France!",
    location: "2418-20",
  ...
  "d2f6d780-eb2e-52c0-ae97-b04e7d42f7bf": {
    ...
    author: "Gabriel Wyner",
    quote:
      "But if you want to learn a heap of grammar at the same time, write out your own examples and definitions. After you get your corrections, you can use the example sentences to teach you your words and use the corrections to teach you your grammar.",
    location: "2446-48",
  ...
  "dc2333e5-115a-537c-8ec3-012c322b5303": {
    ...
    author: "Gabriel Wyner",
    quote:
      "For your very first book, try to find a familiar story—a translation of something you’ve already read or a book that’s been turned into a movie you’ve seen—and read it along with an audiobook. The audiobook will carry you along and help you read faster than you otherwise would. You won’t have the time to get bogged down with unknown words, and you’ll pick up the rhythm of the spoken language.",
    location: "2509-12",
  ...
  "59f0142c-8221-5245-8168-fb3b1f4169dc": {
    ...
    author: "Gabriel Wyner",
    quote:
      "If you want to understand real-world speech, you need to listen to real-world speech. But you can’t just start by listening to foreign news radio all day. It’s just too hard. You’ll get frustrated and you’ll tune out, at which point you might as well be listening to random noise.",
    location: "2540-42",
  ...
  "b2f9b3b9-6c3d-533a-91b1-6889d038ca66": {
    ...
    author: "Gabriel Wyner",
    quote:
      "Instead, watch movies and television. In these genres, you are listening for the stories, and so you’ll pay very careful attention to everything you hear.",
    location: "2548-49",
  ...
  "633c8b78-0b9b-51e4-8f8a-f0d46e3aa37c": {
    ...
    author: "Gabriel Wyner",
    quote:
      "We could keep going: • How do you pronounce “chèvre”? • How do you spell the word pronounced “sheh-vre” () • What’s a food that chèvres eat? • What colors do chèvres come in? • What’s your least favorite memory of a chèvre? But eventually, you’re going to get sick of chèvres, and your flash cards will be too easy.",
    location: "2920-25",
  ...
  "92d357f4-cc2d-5353-b84f-1b28f5052593": {
    ...
    author: "Gabriel Wyner",
    quote:
      "Learn thirty flash cards a day. As you learn them, you’ll tell your SRS what you remember.",
    location: "3137",
  ...
  "f414385a-6d2a-546e-a9d0-b997748a0349": {
    ...
    author: "Yuval Noah Harari",
    quote:
      "He believed that information wants to be free, that ideas don’t belong to the people who created them, and that it is wrong to lock data behind walls and charge money for entrance.",
    location: "5708-9",
  ...
  "829d6034-0bb7-50e8-90a7-b447a0fe13d9": {
    ...
    author: "Yuval Noah Harari",
    quote:
      "Dataist influence, both the life sciences and the social sciences have become obsessed with decision-making processes, as if that’s all there is to life. But is it so? Sensations, emotions and thoughts certainly play an important part in making decisions, but is that their sole meaning? Dataism gains a better and better understanding of decision-making processes, but it might be adopting an increasingly skewed view of life.",
    location: "5866-69",
  ...
  "c99d5c00-93c8-55cd-a22d-52d95bbd42b9": {
    ...
    author: "Dan Luca",
    quote:
      "After that, I ensure that my Morning Ritual is clear and that I’m able to start it as soon as I wake up; I make the decision of waking up early the night before so I can avoid negotiating with myself in the morning; and I make sure that I sleep a minimum of seven hours every night.",
    location: "1059-61",
  ...
  "0f50c1e4-af2d-5c99-b181-64b96ae70d7a": {
    ...
    author: "Dan Luca",
    quote:
      "Sleeping less than seven hours or more than eight hours will take its toll on your health.",
    location: "1113-14",
  ...
  "9f3ee2f6-eaa4-5970-97ab-81e43aee4cfa": {
    ...
    author: "Dan Luca",
    quote:
      "There aren’t compelling studies that reveal the exact negative side effects that sleeping more than eight hours per night has on a person’s health. But this sleep behaviour has been correlated with depression and with difficulties regarding self-perception and the results achieved while performing day-to-day activities.",
    location: "1595-97",
  ...
  "ab8bebd6-48b0-5206-97d4-52cda4ef39b1": {
    ...
    author: "Dan Luca",
    quote:
      "It really helps if you ‘tell’ your body that you’re planning to wake up at X hour so that it may prepare for this situation.",
    location: "1601-2",
    time: "Thursday, May 20, 2021, 02:41 PM",
    favourite: false,
    deleted: true,
